...
/** Tombol Ubah + Hapus di tiap baris agenda, dengan konfirmasi sebelum hapus. */
export function AksiAgendaAdmin({ id, judul }: { id: string; judul: string }) {
  ...
  async function hapus() {
    const setuju = await konfirmasi({
      judul: "Hapus kegiatan ini?",
      teks: `“${judul}” akan dihapus dari jadwal dan tidak bisa dikembalikan.`,
      tombolYa: "Ya, hapus",
      berbahaya: true,
    });
    if (!setuju) return;
